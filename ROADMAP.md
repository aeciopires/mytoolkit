...
- Additional tools: UUID generator, Lorem Ipsum generator, Diff viewer, Cron expression parser.
- Per-tool usage analytics dashboard on the homepage, backed by `/api/v1/metrics/ranking`.
- Optional JWT RSA/ECDSA support (currently HMAC-only).
