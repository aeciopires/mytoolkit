...
Package is `base64enc` (not `base64`, to avoid colliding with stdlib `encoding/base64`). `src/internal/tools/base64enc/base64enc.go`, `func Process(input []byte, opts Options) (string, error)`.
